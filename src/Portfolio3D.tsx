...
/**
 * The interactive 3D portfolio. Lazy-loaded from App so all the heavy three.js /
 * drei / rapier code lands in a separate chunk that only downloads when the
 * visitor actually enters the world — keeping the landing page tiny.
 */
export default function Portfolio3D({ onExit }: { onExit: () => void }) {
